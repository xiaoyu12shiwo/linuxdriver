...
static inline void __arch_decomp_setup(unsigned long arch_id)
{
	...
	do {
		/* Davinci boards */
		DEBUG_LL_DAVINCI(davinci_evm,		1);
		DEBUG_LL_DAVINCI(sffsdr,		1);
		DEBUG_LL_DAVINCI(neuros_osd2,		1);
		DEBUG_LL_DAVINCI(davinci_dm355_evm,	1);
		DEBUG_LL_DAVINCI(dm355_leopard,		1);
		DEBUG_LL_DAVINCI(davinci_dm6467_evm,	1);
		DEBUG_LL_DAVINCI(davinci_dm365_evm,	1);

		/* DA8xx boards */
		DEBUG_LL_DA8XX(davinci_da830_evm,	1);
		DEBUG_LL_DA8XX(davinci_da850_evm,	1);
		DEBUG_LL_DA8XX(davinci_da850_sdi,	1);
		DEBUG_LL_DA8XX(mityomapl138,		1);
		DEBUG_LL_DA8XX(omapl138_lcdkboard,	1);
